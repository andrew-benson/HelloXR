...
public class ExampleScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cube1.transform.position = new Vector3(0.75f, gameObject.transform.position.y, gameObject.transform.position.z);
        cube1.transform.Rotate(90.0f, 0.0f, 0.0f, Space.Self);
        cube1.GetComponent<Renderer>().material.color = Color.red;
        cube1.name = "Self";

        cube2 = GameObject.CreatePrimitive(PrimitiveType.Cube);
        cube2.transform.position = new Vector3(-0.75f, gameObject.transform.position.y, gameObject.transform.position.z);
